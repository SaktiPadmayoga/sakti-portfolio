...
class InfiniteGridMenu {
  ...
  private init(onInit?: InitCallback): void {
    const gl = this.canvas.getContext("webgl2", {
      antialias: true,
      alpha: true, // Mengaktifkan alpha untuk transparansi
    });
    if (!gl) {
...
const InfiniteMenu: FC<InfiniteMenuProps> = ({ items = [] }) => {
  ...
  return (
    <div className="relative w-full h-full bg-transparent rounded-2xl border-2 border-gray-300/50 shadow-2xl shadow-gray-300/50 overflow-hidden">
      <canvas
      ...
      {activeItem && (
        ...
        `}
          ...
          ${
            isMoving
              ? "opacity-0 pointer-events-none duration-[100ms] translate-x-[-40%] sm:translate-x-[-60%] -translate-y-1/2"
              : "opacity-100 pointer-events-auto duration-[500ms] translate-x-[-70%] sm:translate-x-[-90%] -translate-y-1/2"
          }
        `}
          >
          ...
          ${
            isMoving
              ...
              : "bottom-[2.5em] sm:bottom-[3.8em] opacity-100 pointer-events-auto duration-[500ms] scale-100 -translate-x-1/2"
          }
        `}
          >
            <p className="select-none relative text-[#060010] top-[1px] sm:top-[2px] text-[18px] sm:text-[26px]">
              ↗
            </p>
          </div>
        </>

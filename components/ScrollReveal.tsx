...
const ScrollReveal: React.FC<ScrollRevealProps> = ({
  ...
  const triggers = useRef<ScrollTrigger[]>([]); // Simpan referensi ScrollTrigger
  ...
  useEffect(() => {
    ...
    // Simpan trigger untuk pembersihan
    triggers.current = [rotationTrigger, opacityTrigger];
    if (blurTrigger) triggers.current.push(blurTrigger);
